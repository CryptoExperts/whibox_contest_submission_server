...
flash_texts_and_categories = {'BAD_USERNAME_OR_PWD': ('Bad username or password', flash_categories['danger']),
                              'WELCOME_BACK': ('Welcome back %s', flash_categories['success']),
                              'SIGNOUT': ('You have signed out', flash_categories['info']),
                              'ERROR_USER_EXISTS': ('An error occured. The username might already exist.', flash_categories['danger']),
